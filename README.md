...
- Time-directional variation operator D and its adjoint operator D* are now calculated using Matlab `diff` function, which results in approximately 43 % speed up compared with the ones in the original algortihm.
